#!/usr/bin/env python
"""Test poster generation with real TMDb items."""
...
async def main():
    ...
    try:
        ...
        items = await tmdb.get_trending_movies("week", limit=20)
        ...
        print("\nGenerating poster with DALL-E 3...")
        result = await poster_gen.generate_poster(
            config=config,
            items=items,
            category="FILMS",
            force_regenerate=True,
            use_dalle3=False,  # Test with gpt-image-1.5
        )
