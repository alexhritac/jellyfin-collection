#!/usr/bin/env python
"""Test poster generation with cartoons/animated content."""
...
async def main():
    ...
    try:
        # Fetch animated movies (genre 16 = Animation)
        print("Fetching animated movies from TMDb...")
        ...
        # Generate poster
        print("\nGenerating poster for CARTOONS...")
